...
public class AlgamoneyExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Autowired
    private MessageSource messageSource; //objeto do Spring
    ...
    @ExceptionHandler({EmptyResultDataAccessException.class})//definindo a exceção a ser tratada
    ...
    public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request) {
        ...
        String mensagemDesenvolvedor = ExceptionUtils.getRootCauseMessage(ex); //retorna msg da causa raix da exception
        List<Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDesenvolvedor));
    ...
    public ResponseEntity<Object> handleInvalidDataAccessApiUsageException(InvalidDataAccessApiUsageException ex, WebRequest request) {
        String mensagemUsuario = messageSource.getMessage("recurso.operacao-nao-permitida", null, LocaleContextHolder.getLocale());
        String mensagemDesenvolvedor = ex.toString();//retorna msg da causa raiz da exception
        List<Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDesenvolvedor));
        return handleExceptionInternal(ex, erros, new HttpHeaders(), HttpStatus.BAD_REQUEST, request);
    }
